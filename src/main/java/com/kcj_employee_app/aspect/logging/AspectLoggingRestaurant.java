...
public class AspectLoggingRestaurant {
    ...
    */
   @Pointcut("execution(* com.kcj_employee_app.service.admin.RestaurantService.addRestaurant(..))")
    ...
    */
   @Pointcut("execution(* com.kcj_employee_app.service.admin.RestaurantService.updateRestaurant(..))")
    ...
    */
   @Pointcut("execution(* com.kcj_employee_app.service.admin.RestaurantService.closeRestaurant(..))")
