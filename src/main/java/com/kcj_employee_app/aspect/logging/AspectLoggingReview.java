...
public class AspectLoggingReview {
    ...
    */
   @Pointcut("execution(* com.kcj_employee_app.service.admin.ReviewService.addReview(..))")
    ...
    */
   @Pointcut("execution(* com.kcj_employee_app.service.admin.ReviewService.updateReview(..))")
    ...
    */
   @Pointcut("execution(* com.kcj_employee_app.service.admin.ReviewService.deleteReview(..))")
